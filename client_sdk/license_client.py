...
class LicenseClient:
    ...
    def __init__(self, server_url: str, app_name: str, app_version: str, public_key: str):
        """
        ...
        Args:
            ...
            public_key: PEM-formatted RSA public key for verifying server responses.
        """
    ...
    def validate_license(self, license_key: str, force_refresh: bool = False) -> LicenseInfo:
        ...
        if response.status_code == 200:
            ...
            if not signature:
                raise LicenseValidationError("License response is unsigned — signature required")
            from .utils.rsa_verification import RSAVerifier
            sign_data = {
            ...
            if not RSAVerifier.verify_signature(sign_data, signature, self.public_key):
                raise LicenseValidationError("License response signature verification failed")
