...
# Load your server's public key — obtain this from your license server administrator.
# You can also load it from a file:
#   with open("license_server_public.pem") as f: PUBLIC_KEY = f.read()
PUBLIC_KEY = """-----BEGIN PUBLIC KEY-----
<your server's RSA public key here>
-----END PUBLIC KEY-----"""

class LicenseManager:
    """Advanced license manager with caching and periodic validation"""

    def __init__(self, server_url: str, license_key: str, public_key: str):
        self.client = LicenseClient(server_url, "MyApp", "1.0.0", public_key)
...
def application_integration_example():
    ...
    license_manager = LicenseManager("http://localhost:8000", license_key, PUBLIC_KEY)
...
def offline_validation_simulation():
    ...
    client = LicenseClient("http://nonexistent-server:8000", "MyApp", "1.0.0", PUBLIC_KEY)
    license_key = "ABCDE-FGHIJ-KLMNO-PQRST-UVWXY"
...
def multi_application_example():
    ...
    client = LicenseClient("http://localhost:8000", "MyApp", "1.0.0", PUBLIC_KEY)
