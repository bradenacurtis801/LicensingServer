...
from app.core.signing import sign_response
...
class ValidationService:
    ...
    def _sign(self, response: LicenseValidationResponse) -> LicenseValidationResponse:
        sign_data = {
        ...
        return response.model_copy(update={"signature": sign_response(sign_data)})
    ...
    def validate_license(
        ...
        if not self.generator.validate_key_format(request.license_key):
            return self._sign(LicenseValidationResponse(
                valid=False,
