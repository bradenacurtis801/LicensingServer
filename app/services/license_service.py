...
from app.models.database import Application, Customer, LicenseKey, User
from app.models.schemas import (
    LicenseKeyCreate,
    LicenseKeyResponse,
    LicenseKeyUpdate,
    LicenseKeyWithRelationsResponse,
)
...
class LicenseService:
    ...
    def get_license_by_hash(self, key_hash: str) -> Optional[LicenseKey]:
        """Get a license database model by key hash"""
        return self.db.exec(
    ...
    def list_licenses(self, user: User, skip: int = 0, limit: int = 100, include_relations: bool = False) -> List[Union[LicenseKeyResponse, LicenseKeyWithRelationsResponse]]:
        ...
        if include_relations:
            from app.models.schemas import ApplicationResponse, CustomerResponse
