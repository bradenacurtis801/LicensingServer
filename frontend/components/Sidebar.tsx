...
const navigation = [
  ...
  { name: 'Applications', href: '/applications', icon: CogIcon },
  { name: 'Activation Forms', href: '/activation-forms', icon: ClipboardDocumentListIcon },
  { name: 'API Tokens', href: '/api-tokens', icon: DocumentTextIcon },
]
