...
class LicenseKeyCreate(BaseModel):
    ...
    max_activations: Optional[StrictInt] = 1
    features: Optional[Dict[str, Any]] = None
    notes: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["customer_id", "application_id", "expires_at", "max_activations", "features", "notes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_activations": obj.get("max_activations") if obj.get("max_activations") is not None else 1,
